...
for T in Temperatures:
    for P in Pressures:
        print("F:/PhD/TCPDecompositionExperiments/Completed/Fe3O4/{}/{}/".format(T, P))
        # sys.path.append("/home/carlos/anaconda3/lib/python3.7/site-packages")
        sys.path.append(
            "F:/PhD/TCPDecompositionExperiments/Completed/Fe3O4/{}/{}/processed/".format(T, P))
        import numpy as np
        ...
        if __name__ == "__main__":
            ...
            dir = 'F:/PhD/TCPDecompositionExperiments/Completed/Fe3O4/{}/{}/'.format(T, P)  # CHANGEHERE
            directories = [dir]
            ...
            for border in borders:
                for ind, direct in enumerate(directories):
                    ...
                    datafile = 'F:/PhD/TCPDecompositionExperiments/Completed/Fe3O4/{}/{}/48_TCP_Fe3O4_100_scv.data'.format(
                        T, P)  # CHANGEHERE
                    starting_bfile = 'F:/PhD/TCPDecompositionExperiments/Completed/Fe3O4/{}/{}/48_TCP_Fe3O4_100_scv-BONDS.data'.format(
                        T, P)  # CHANGEHERE

                    start = time.time()
                    tal = Networkgen(datafile, starting_bfile)
                    tal.ovito_mols(
                        fout='F:/PhD/TCPDecompositionExperiments/Completed/Fe3O4/{}/{}/'.format(
                    ...
                    # fout_CH='F:/PhD/TCPDecompositionExperiments/Completed/Fe3O4/{}/{}/'.format(T, P)+system+'C_2-H_1'+str(border)
                    ...
                    fout = 'F:/PhD/TCPDecompositionExperiments/Completed/Fe3O4/{}/{}/processed/'.format(
                        T, P) + system + '_b' + str(  # CHANGEHERE
                        border)
                    fout_new = 'F:/PhD/TCPDecompositionExperiments/Completed/Fe3O4/{}/{}/processed/'.format(
                        T, P) + system + '_new_b' + str(  # CHANGEHERE
                        border)
                    fout_start = 'F:/PhD/TCPDecompositionExperiments/Completed/Fe3O4/{}/{}/processed/'.format(
                    ...
                    path_name_data_out = "F:/PhD/TCPDecompositionExperiments/Completed/Fe3O4/{}/{}/ovito_datafiles/".format(
                        T, P) + system + '_'  # CHANGEHERE

                    datafile_for_header = '48_TCP_Fe3O4_100_scv.data'
                    ...
                    fout_intact = 'F:/PhD/TCPDecompositionExperiments/Completed/Fe3O4/{}/{}/processed/'.format(
        ...
        MoleculesIntact = pd.read_csv(
            'F:/PhD/TCPDecompositionExperiments/Completed/Fe3O4/{}/{}/processed/Fe2O3-200-iso-octane_IntactMols_0.3'.format(
                T, P),
            sep='\t')
        """
        ...
        MoleculesIntact.to_excel(
            'F:/PhD/TCPDecompositionExperiments/Completed/Fe3O4/{}/{}/processed/Intact.xlsx'.format(
                T, P),
            'Sheet 1', index=False)
        """
        ...
        """
        MoleculesIntactValue = MI[['Timestep', 'Intact_molecules_noomit']]
        """
        ...
        """
        ax = MoleculesIntactValue.plot.line(x='Timestep', y='Intact_molecules_noomit')
        plt.savefig(
            'F:/PhD/TCPDecompositionExperiments/Completed/Fe3O4/{}/{}/processed/Intact.png'.format(
                T, P))
        ...
        NewMolecules = pd.read_csv(
            'F:/PhD/TCPDecompositionExperiments/Completed/Fe3O4/{}/{}/processed/Fe2O3-200-iso-octane_b0.3'.format(
                T, P), sep='\t')
        """
        ...
        NewMolecules.to_excel(
            'F:/PhD/TCPDecompositionExperiments/Completed/Fe3O4/{}/{}/processed/NewMolecules.xlsx'.format(
                T, P),
            'Sheet 1', index=False)
        """
        The above code is what translates from a text file to an excel file:
        ...
        while Index < NumberofBondTypes:
            ...
            plt.savefig(
                'F:/PhD/TCPDecompositionExperiments/Completed/Fe3O4/{}/{}/processed/'.format(T, P) + GRAPHNAME + '.png')
            # plt.show()
            Index += 1
